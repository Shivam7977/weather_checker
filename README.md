...
bashgit clone https://github.com/your-username/skypulse.git
cd skypulse
2. Get your API Key
...
🛠️ Tech Stack
TechnologyUsageHTML5StructureCSS3Styling, animations, glassmorphismVanilla JavaScriptLogic, API callsOpenWeatherMap APILive weather dataGoogle FontsBebas Neue + DM Sans
